...
static const unanswered_vector UNANSWERED_VECTORS[] = {
    {"an unmatched intent is unanswered, not a refusal", "{\"msg_type\":\"bus\",\"payload\":{\"type\":\"ovos.intent.unmatched\",\"data\":{\"utterance\":\"book me a flight to the moon\",\"lang\":\"en-US\"},\"context\":{\"request_id\":\"req-1\",\"session\":{\"session_id\":\"sat-1\"}}}}"},
